        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div style="position: relative; left: 40px;">
                    姓名：<b>${loginUser.name}</b><br><br>
                    登录帐号：<b>${loginUser.loginAct}</b><br><br>
                    组织机构：<b>#</b><br><br>
                    邮箱：<b>${loginUser.email}</b><br><br>
                    失效时间：<b>${loginUser.expireTime}</b><br><br>
                    允许访问IP：<b>${loginUser.allowIps}</b>
                </div>
            </div>
    ...
    <div class="modal-dialog" role="document" style="width: 70%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="pwdbtn" class="btn btn-primary">更新
                </button>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" data-dismiss="modal"
                        onclick="window.location.href='/user/exit.do';">确定
                </button>
            </div>
        </div>
    </div>
