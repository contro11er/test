...
<head>
    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            $("#searchForm").ajaxForm(intiData).submit();

            var formJSON = {};
            $("#searchBtn").click(function () {
                formJSON = $("#searchForm").formJSON();
                $("#currentPage").val("");
            });

            function intiData(page) {
                //分页属性设置
                $("#page").bs_pagination({
                    ...
                    onChangePage: function (event, data) {
                        formJSON.currentPage = data.currentPage;
                        formJSON.rowsPerPage = data.rowsPerPage;
                        $.ajax({
                            url: "/clue/getLikeList.json",
                            data: formJSON,
                            success: intiData
                        });
                    }
                ...
                $(page.data).each(function () {
                    html += `<tr>
                                ...
                                <td><a href="/workbench/clue/detail.html?id=` + this.id + `" style="text-decoration:none;cursor:pointer;">` + (this.fullName || "") + `</a></td>
                                <td>` + (this.company || "") + `</td>
                                <td>` + (this.phone || "") + `</td>
                                <td>` + (this.mphone || "") + `</td>
                                <td>` + (this.source || "") + `</td>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <select class="form-control" id="create-call">
                                <option></option>
                                <c:forEach items="${zd.appellation}" var="z">
                                    <option>${z}</option>
                                </c:forEach>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <select class="form-control" id="create-status">
                                <option></option>
                                <c:forEach items="${zd.clueState}" var="z">
                                    <option>${z}</option>
                                </c:forEach>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <select class="form-control" id="create-source">
                                <option></option>
                                <c:forEach items="${zd.source}" var="v">
                                    <option>${v}</option>
                                </c:forEach>
                            </select>
                        </div>
...
<div style="position: relative; top: -20px; left: 0px; width: 100%; height: 100%;">
    ...
    <div style="width: 100%; position: absolute;top: 5px; left: 10px;">
        ...
        <div class="btn-toolbar" role="toolbar" style="height: 80px;">
            <form id="searchForm" action="/clue/getLikeList.json" method="post" class="form-inline" role="form"
                  style="position: relative;top: 8%; left: 5px;">
                <input id="currentPage" type="hidden" name="currentPage">
                <input id="rowsPerPage" type="hidden" name="rowsPerPage">
        ...
        <div class="btn-toolbar" role="toolbar"
            ...
            <div class="btn-group" style="position: relative; top: 18%;">
                ...
                <button id="edit" type="button" class="btn btn-default" data-toggle="modal"
                ><span
