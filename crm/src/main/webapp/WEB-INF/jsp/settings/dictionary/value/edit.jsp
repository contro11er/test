...
<div style="position:  relative; left: 30px;">
    ...
    <div style="position: relative; top: -40px; left: 70%;">
        <button id="edibtn" type="button" class="btn btn-primary">更新</button>
        <button type="button" class="btn btn-default" onclick="window.history.back();">取消</button>
    </div>
    <hr style="position: relative; top: -40px;">
</div>
<form id="ediform" action="/value/edit.do" method="post" class="form-horizontal" role="form">
    <input type="hidden" name="id" value="${v.id}">
    <div class="form-group">
        <label for="edit-dicTypeCode" class="col-sm-2 control-label">字典类型编码</label>
        <div class="col-sm-10" style="width: 300px;">
            <input name="tid" type="text" class="form-control" id="edit-dicTypeCode" style="width: 200%;"
                   value="${v.tid}" readonly>
        </div>
    </div>
    ...
    <div class="form-group">
        <label for="edit-text" class="col-sm-2 control-label">文本值</label>
        <div class="col-sm-10" style="width: 300px;">
            <input name="text" type="text" class="form-control" id="edit-text" style="width: 200%;" value="${v.text}">
        </div>
    </div>
