...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#saveBtn").click(function () {
            var $name = $("#create-loginActNo").val();
            var $pwd = $("#create-loginPwd").val();
            var $Cpwd = $("#create-confirmPwd").val();
            if ($name == '') {
                alert("请输入登录账号");
                return;
            }
            ...
            $.ajax({
                url: "/user/getUserById.json?id=" + $name,
                success: function (result) {
                    if (result != '') {
                        alert("账号已存在，请重新填写");
                        return;
    ...
    <div class="modal-dialog" role="document" style="width: 90%;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="addForm" action="/user/add.do" method="post" class="form-horizontal" role="form">
...
<div class="btn-toolbar" role="toolbar"
    ...
    <div class="btn-group" style="position: relative; top: 18%;">
        <button id="addBtn" type="button" class="btn btn-primary" data-toggle="modal"
                data-target="#createUserModal"><span
